...
#define PASS "blackbird16111992"
#define IP "api.thingspeak.com" //IP Thinkspeak
/*Tipe*/
...
void loop()                         //MainKodePerulangan
{
  ...
  if (kualitasUdara > 105){
    deskKu = "buruk  ";
  } else if (kualitasUdara >= 90 && kelembapan <= 105){
    deskKu = "baik  ";
  } else if (kualitasUdara < 90){
    deskKu = "kurang";
  }
  /*Deskripsi Waktu*/
